...
import '../treinament/treinament_widget.dart';
...
class _CadastroUsuarioWidgetState extends State<CadastroUsuarioWidget> {
  ...
  _consultaCep() async {
    ...
    setState(() {
      ...
      campoCidadeController.text = resultadoCidade;
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (val) {
                                    if (val == null || val.isEmpty) {
                                      return 'Preencher campo nome completo';
                                    }
                                    if (val.length < 1) {
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                 ...
                                 onChanged: (campoCepController) {
                                  ...
                                  validator: (val) {
                                    if (val == null || val.isEmpty) {
                                      return 'Preencher campo CEP *Apenas números';
                                    }
                                    if (val.length < 1) {
                                      return 'Requires at least 1 characters.';
                                    }
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (val) {
                                    if (val == null || val.isEmpty) {
                                      return 'Preencher campo logradouro';
                                    }
                                    if (val.length < 1) {
                                      return 'Requires at least 1 characters.';
                                    }
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await POSTUsuarioCall.call(
                                    ...
                                    estado: campoCidadeController.text,
                                    telefone:
